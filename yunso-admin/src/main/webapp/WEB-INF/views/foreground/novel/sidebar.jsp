...
<head lang="en">
  <meta charset="UTF-8">
  <title>${novel.chapters.get(0).chaptername}</title>
...
<header class="am-g my-head">
  <div class="am-u-sm-12 am-article">
    <h1 class="am-article-title">${novel.chapters.get(0).chaptername}</h1>
    <p class="am-article-meta">${novel.author},《${novel.chapters.get(0).novelname}》</p>
  </div>
</header>
    ...
    <div class="am-g">
      <div class="am-u-sm-11 am-u-sm-centered">
        <div class="am-cf am-article">
          ${novel.chapters.get(0).content.replace("    ","<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;").replace("FQxSw.com","")}
        </div>
        <hr/>
      </div>
    </div>
  ...
  <div class="am-u-md-3 am-u-md-pull-9 my-sidebar">
    <div class="am-sticky-placeholder" style="height: 996px; margin: 0px;">
      <div id="amz-offcanvas" class="am-offcanvas doc-offcanvas" style="margin: 0px;">
        <section class="amz-sidebar am-offcanvas-bar" style="overflow-y: scroll;height: 80%">
          <ul class="am-nav" >
          <li>${novel.chapters.get(0).chaptername}</li>
          <li class="am-nav-header">目录</li>
          <c:forEach items="${novel.chapters}" var="chapter" end="30">
            <li><a href="#">${chapter.chaptername}</a></li>
          </c:forEach>
        </ul>
        </section>
      </div>
