            ...
            <div class="card TopstoryItem">
                ...
                <div class="card-content">
					...
					<span style=" white-space: normal;height: 75%;display: block;">
                        ...
                        <span style="display: inline-block;margin-top: 31px;"><a  class="layui-btn" href="${pageContext.request.contextPath}/novel/read/${novelInfo.novelName}">开始阅读</a></span>
                        <span style="display: inline-block;margin-top: 31px;"><a  class="layui-btn" href="${pageContext.request.contextPath}/novel/chapter/${novelInfo.novelName}">章节目录</a></span>
                        <span style="display: inline-block;margin-top: 31px;"><a  class="layui-btn" href="${pageContext.request.contextPath}/novel/conllection/${novelInfo.novelName}">加入收藏</a></span>
                    </div>
                </div>
